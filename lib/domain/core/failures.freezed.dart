...
class _$ValueFailureTearOff {
  ...
  InvalidPhone<T> invalidPhone<T>({T? failedValue}) {
    return InvalidPhone<T>(
      failedValue: failedValue,
    );
  }

  InvalidList<T> invalidList<T>({T? failedValue}) {
...
mixin _$ValueFailure<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(T? failedValue) invalidList,
  }) =>
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(T? failedValue)? invalidList,
  ...
  TResult map<TResult extends Object?>({
    ...
    required TResult Function(InvalidList<T> value) invalidList,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>({
    ...
    TResult Function(InvalidList<T> value)? invalidList,
    required TResult orElse(),
  }) =>
      throw _privateConstructorUsedError;
...
abstract class InvalidPhone<T> implements ValueFailure<T> {
  const factory InvalidPhone({T? failedValue}) = _$InvalidPhone<T>;
...
abstract class InvalidList<T> implements ValueFailure<T> {
  const factory InvalidList({T? failedValue}) = _$InvalidList<T>;

...
class _$CategoryDtoTearOff {
  ...
  _CategoryDto call({String? name, String? image}) {
    return _CategoryDto(
      name: name,
      image: image,
    );
...
class _$_CategoryDto extends _CategoryDto {
  const _$_CategoryDto({this.name, this.image}) : super._();
  ...
  @override
  String toString() {
    return 'CategoryDto(name: $name, image: $image)';
  }
...
abstract class _CategoryDto extends CategoryDto {
  const factory _CategoryDto({String? name, String? image}) = _$_CategoryDto;
